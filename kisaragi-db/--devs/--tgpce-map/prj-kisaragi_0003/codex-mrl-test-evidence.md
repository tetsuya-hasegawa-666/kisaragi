...
- record date: 2026-03-20
  ...
  resolution: `Termius` 統一、`Moshi` 競合なし、個人 PC 前提を `admin-mrl-test-method.md` に反映した
...
- record date: 2026-03-20
  ...
  resolution: `kisaragi-db/--devs/--project-truth/prj-kisaragi_0003/recovery_contract.md` を新設し、command surface と evidence layout を固定した
  recurrence prevention: contract 変更は `recovery_contract.md` を先に更新する
  remaining work: `Synceller` 実 runtime command の接続
  evidence path: `kisaragi-db/--devs/--project-truth/prj-kisaragi_0003/recovery_contract.md`
- record date: 2026-03-20
  target MRL: `MRL-1`
  target mRL: `mRL-1.3`
  gate change: `pass`
...
- record date: 2026-03-20
  ...
  resolution: `admin-mrl-test-method.md` に接続 profile と reachability を記載した
  recurrence prevention: 主系統の到達条件は runbook を正本にする
  remaining work: host への config 適用と実接続確認
  evidence path: `kisaragi-db/--devs/--evidence/prj-kisaragi_0003/admin-mrl-test-method.md`
- record date: 2026-03-20
  target MRL: `MRL-2`
  target mRL: `mRL-2.3`
  gate change: `pass`
...
- record date: 2026-03-20
  ...
  resolution: `admin-mrl-test-method.md` に主系統継続と GUI fallback の分岐条件を追加した
...
- record date: 2026-03-20
  ...
  resolution: `admin-mrl-test-method.md` に実設定マニュアルを追記した
...
- record date: 2026-03-21
  ...
  resolution: `kisaragi-db/--devs/--project-truth/prj-kisaragi_0003/remote-pwsh_add-vision.md` を追加し、story ベースで拡張 UX、かたい設計、guided UX を提案した
  ...
  evidence path: `kisaragi-db/--devs/--project-truth/prj-kisaragi_0003/remote-pwsh_add-vision.md`
- record date: 2026-03-21
  target MRL: `MRL-6`
  target mRL: `mRL-6.1`
  gate change: `pass`
