...
| `#13-1` | `cells/13_01.py` | pre-merge pose gate | `to_4x4_batch`, `build_anchor_c2w_list`, `local_c2w_list`, `estimate_pose_aware_similarity`, `transform_c2w_list` | `anchor_dir`, `camera_anchor_full_path`, `LOCAL_EXTRINSIC_MODE`, `LOCAL_CAMERA_BASIS`, `residual_df`, `gate_df`, `validation_df`, `summary` | `persist_root/01_anchor`, `pipeline_root/manifests`, `pipeline_root/chunk_runs`, `pipeline_root/merged`, `final_outputs/diagnostics` | `pred_vs_anchor_pose_residual.csv`, `premerge_pose_gate.csv`, `premerge_pose_validation.csv`, `premerge_pose_validation.json` | `DOC-C13-01` |
| `#14-1` | `cells/14_01.py` | merge 本体 | `ensure_target_chunk_manifest`, `resolve_chunk_input_dir` | `persist_root`, `anchor_dir`, `global_anchor_df`, `global_camera_matrix_df`, `LOCAL_EXTRINSIC_MODE`, `LOCAL_CAMERA_BASIS`, `chunk_global_transforms_arc`, `keep_df`, `merge_summary` | `persist_root/01_anchor`, `pipeline_root/manifests`, `pipeline_root/chunk_runs`, `pipeline_root/merged`, `final_outputs/*` | `merged_gs_arc.ply`, `merged_scene_arc.glb`, `chunk_global_transforms_arc.csv`, `chunk_keep_summary_arc.csv`, `chunk_transform_quality_arc.csv`, `owner_record_histogram_arc.csv`, `chunk_assignment_summary_arc.csv`, `merge_summary.json`, `final_output_manifest_arc.json` | `DOC-C14-01` |
