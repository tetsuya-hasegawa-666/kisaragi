...
| merge 契約 | `#11-1..#11-2` | graph で確定した chunk-to-world を使って merge し、merged pose / NGL bundle / GS artifact と review visualization を一体で残す | `persist_root/01_anchor`, `pipeline_root/manifests`, `pipeline_root/chunk_runs`, `final_outputs/#11-1/re_access`, `final_outputs/#11-1/persist_only` | `merge_summary.json`, `merged_camera_pose_arc.csv`, `merged_camera_matrix_arc.csv`, merged GS / GLB、review HTML、handoff manifest |
