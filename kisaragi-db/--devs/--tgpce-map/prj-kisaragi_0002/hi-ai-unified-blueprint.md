...
| `PATH-I03` | `chunk_execution_plan.csv` | `#8-3,#8-5` | `#8-4,#8-6,#8-7,#8-9,#10-1,#11-1,#11-2` | `pipeline_root/manifests/chunk_execution_plan.csv` | canonical chunk planning / execution manifest。target subset、execution batch、`batch_work_dir`、`chunk_out_dir` を 1 file で持つ |
| `PATH-I03B` | `batch_execution_items.csv` | `#8-3,#8-7` | `#8-4,#8-5,#8-9,#10-1` | `pipeline_root/manifests/batch_execution_items.csv` | backward 互換の派生 execution item manifest |
