...
| `PATH-I03` | `batch_execution_items.csv` | `#8-3,#8-7` | `#8-4,#8-5,#8-9,#10-1,#11-2` | `pipeline_root/manifests/batch_execution_items.csv` | canonical chunk execution item manifest |
...
| `PATH-I10` | `pred_extrinsics.npy` | `#8-8` | `#8-9,#9-1,#10-1,#11-1,#11-2` | `pipeline_root/chunk_runs/<batch_name>/<chunk_name>/pred_extrinsics.npy` | chunk 単位 pose artifact |
| `PATH-I11` | `chunk_input_frames.csv` | `#8-8` | `#9-1,#11-1` | `pipeline_root/chunk_runs/<batch_name>/<chunk_name>/chunk_input_frames.csv` | chunk 実行時に使った frame manifest |
