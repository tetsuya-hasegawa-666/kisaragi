...
| `MRL-4` | `-` | `trajectreview-modeling` で実 bundle 読込、request preflight、`Google Drive` directory intake までを成立させる | `sd6`,`sd7`,`sd8`,`su12`,`sd11` | `bd13`,`bd14`,`bd16`,`bu16`,`bd20` | `td12`,`td13`,`td14`,`tu20`,`td23` | `p-done` | `p-done` | `modeling batch 操作手順 1-9` | `modeling batch 定義`, `2026-03-29 modeling preflight close evidence` |
