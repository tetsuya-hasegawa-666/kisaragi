...
| `MRL-9` | `-` | `DA3 Giant` または<br>`Giant Large` の<br>Gaussian branch を<br>`infer_gs=True` で実装し、<br>`gs_ply` / `gs_video` 生成と<br>外部 viewer 可視化を first route として固める | `sd9`,`su15`,<br>`sd11` | `bd18a`,`bd20` | `td19a`,`td19b`,<br>`td23` | `active` | `active` | temp-da3Giant_<br>colab_evid_<br>runbook.md | `未収載` |
