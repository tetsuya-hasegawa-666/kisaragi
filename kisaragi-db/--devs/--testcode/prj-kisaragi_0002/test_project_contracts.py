...
PRODUCT_ROOT = ROOT / "--products" / "prj-kisaragi_0002"
...
class RevieworkProjectContractsTest(unittest.TestCase):
    def test_project_files_do_not_reference_other_projects(self) -> None:
        project_dirs = [
            ROOT / "--plans" / "prj-kisaragi_0002",
            ROOT / "--products" / "prj-kisaragi_0002",
            ROOT / "--project-truth" / "prj-kisaragi_0002",
            ROOT / "--state" / "prj-kisaragi_0002",
            ROOT / "--testcode" / "prj-kisaragi_0002",
        ]
        allowed = {"prj-kisaragi_0002"}
    ...
    def test_output_routing_uses_exsams_and_testlogs(self) -> None:
        ...
        self.assertIn("--exsams/prj-kisaragi_0002", build_file)
        self.assertNotIn("--trial-data", build_file)
        self.assertIn("--testlogs/prj-kisaragi_0002", app_build_file)
        self.assertIn("--exsams/prj-kisaragi_0002", app_build_file)
        self.assertNotIn("--trial-data", app_build_file)
        self.assertIn("--testlogs\\prj-kisaragi_0002", android_script)
        self.assertIn("--exsams\\prj-kisaragi_0002", android_script)
        self.assertNotIn("--trial-data", android_script)
        self.assertIn("--testlogs\\prj-kisaragi_0002", python_script)
        self.assertIn("--exsams\\prj-kisaragi_0002", python_script)
    ...
    def test_stage_handoff_contract_covers_all_four_stages(self) -> None:
        ...
        project_truth = (ROOT / "--project-truth" / "prj-kisaragi_0002" / "project-truth.md").read_text(encoding="utf-8")
