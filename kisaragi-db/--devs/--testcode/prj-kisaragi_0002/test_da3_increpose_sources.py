...
class Da3IncreposeSourcesTest(unittest.TestCase):
    ...
    def test_incremental_pose_contract_is_explicit(self) -> None:
        ...
        self.assertIn('"stage_10_dir": str(stage_10_dir)', path_source)
        self.assertIn('stage_10_dir = Path(paths["stage_10_dir"])', context_source)
        ...
        self.assertIn('stage_10_dir = Path(ctx.get("stage_10_dir"', graph_source)
        self.assertIn('graph_gate_report_path = stage_10_persist_only_dir / "graph_gate_report.json"', graph_source)
        self.assertIn('graph_contract_manifest_path = stage_10_dir / "graph_contract_manifest.json"', graph_source)
        ...
        self.assertIn('merge_input_report_path = merge_persist_only_dir / "merge_input_report.json"', merge_source)
        self.assertIn('stage_11_2_manifest_path = merge_reaccess_dir / "11_2_handoff_manifest.json"', merge_source)
