...
- record date: `2026-03-25`
  ...
  resolution: `project-truth.md` と計画正本を更新し、再開基線を `prj-reviework` 配下へ集約した
  ...
  evidence path: `kisaragi-db/--devs/--plans/prj-reviework/b2t-plans-result.md`
- record date: `2026-03-25`
  target MRL: `MRL-1`
...
- record date: `2026-03-25`
  ...
  evidence path: `kisaragi-db/--devs/--testcode/prj-reviework/test_project_contracts.py`
