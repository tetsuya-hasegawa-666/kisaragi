...
- `npm test`
  - result: pass
  - evidence: `../../../--exsams/prj-kisaragi_0001/logs/2026-03-25-npm-test.log`
  - summary: `8 files`, `28 tests` pass
- `npm run build`
  - result: pass
  - evidence: `../../../--exsams/prj-kisaragi_0001/logs/2026-03-25-npm-build.log`
  - dist file list: `./dist-file-list.txt`
- static preview smoke check
  - result: pass
  - evidence: `../../../--exsams/prj-kisaragi_0001/logs/2026-03-25-preview-check.txt`
...
- launch shortcut smoke check
  - result: pass
  - evidence: `../../../--exsams/prj-kisaragi_0001/logs/2026-03-25-launcher-check.txt`
  - summary: `C:\Users\tetsuya\kisaragi\kisaragi_0001-launch.cmd` から起動した live-state は `kisaragi` 直下全体を `db-view` / `prj-view` で返し、既定 profile は `prj-view` として test で固定した
