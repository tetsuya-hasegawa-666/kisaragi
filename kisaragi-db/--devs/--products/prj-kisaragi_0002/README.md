...
- admin が貼り付け用 block を参照する companion は [colab/da3_colab_ref_runbook.md](C:\Users\tetsuya\kisaragi\kisaragi-db\--devs\--products\prj-kisaragi_0002\colab\da3_colab_ref_runbook.md) とする。
