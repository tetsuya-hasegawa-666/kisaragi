...
- `prj-kisaragi_0002` の `DA3 sequence-anchor` `Colab bootstrap` 正本は [colab/da3_ngl_runbook.md](C:\Users\tetsuya\kisaragi\kisaragi-db\--devs\--products\prj-kisaragi_0002\colab\da3_ngl_runbook.md) とする。
- admin が Colab でそのまま実行する notebook companion は [colab/da3_ngl_runbook.ipynb](C:\Users\tetsuya\kisaragi\kisaragi-db\--devs\--products\prj-kisaragi_0002\colab\da3_ngl_runbook.ipynb) とする。
