...
$testRoot = Join-Path $projectRoot "..\..\--testcode\prj-kisaragi_0002"
$testlogsRoot = Join-Path $projectRoot "..\..\--testlogs\prj-kisaragi_0002"
$exsamsRoot = Join-Path $projectRoot "..\..\..\--exsams\prj-kisaragi_0002"
