...
1. `docs/artifact/recovery_contract.md` を見れば、`doctor -> resume -> recheck -> summary` の contract と evidence 仕様が 1 枚で読める
2. `docs/process/ssh_shell_runbook.md` を見れば、`Termius` から Windows `PowerShell` に入るための最小 runbook が追える
3. `scripts/Invoke-RemoteRecover.ps1 -WhatIf` を実行すると、`synceller doctor` 連携済みの evidence 一式が `--process/--testlogs/prj-remote-pwsh/` に残る
...
- `../../docs/artifact/recovery_contract.md`
- `../../docs/process/ssh_shell_runbook.md`
- `--process/--testlogs/prj-remote-pwsh/artifacts/20260320-153627-rr-20260320-153627-summary.json`
...
1. `Invoke-RemoteResume.ps1` から `--process/--products/prj-synceller/scripts/resume.ps1` を呼び、live recovery を実行できる
...
- `/codex status` の capture を `--process/--testlogs/prj-remote-pwsh/captures/` に定型保存する
- GUI fallback の reachability と共通 script 起動を確認する
- 主系統優先と手動介入の decision matrix を runbook 化する

## Evidence

- `--process/--testlogs/prj-remote-pwsh/logs/20260320-183435-rr-20260320-183435-resume.json`
- `--process/--testlogs/prj-remote-pwsh/logs/20260320-183559-rr-20260320-183559-doctor.json`
- `--process/--testlogs/prj-remote-pwsh/artifacts/20260320-183559-rr-20260320-183559-summary.json`
...
- `--process/--testlogs/prj-remote-pwsh/logs/20260321-052306-rr-20260321-052306-resume.json`
- `--process/--testlogs/prj-remote-pwsh/artifacts/20260321-052408-rr-20260321-052408-summary.json`
...
1. `docs/process/decision_matrix.md` を見れば、SSH 継続と GUI fallback の切替条件が 1 枚で分かる
2. `docs/process/ssh_shell_runbook.md` を見れば、`Termius` 初回設定で詰まりやすい点を回避できる
3. `docs/process/gui_fallback_runbook.md` を見れば、`RustDesk` で同じ recovery script を呼ぶ手順が分かる
...
- `../../docs/process/decision_matrix.md`
- `../../docs/process/ssh_shell_runbook.md`
- `../../docs/process/gui_fallback_runbook.md`
...
- `--process/--testlogs/prj-remote-pwsh/artifacts/20260321-054028-rr-20260321-054028-summary.json`
- `--process/--testlogs/prj-remote-pwsh/captures/20260321-084541-rr-20260321-084541-slack-status.png`
