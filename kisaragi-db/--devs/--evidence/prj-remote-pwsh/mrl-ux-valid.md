...
1. `kisaragi-db/--devs/--project-truth/prj-remote-pwsh/recovery_contract.md` を見れば、`doctor -> resume -> recheck -> summary` の contract と evidence 仕様が 1 枚で読める
2. `kisaragi-db/--devs/--evidence/prj-remote-pwsh/ux_check_manual.md` を見れば、`Termius` から Windows `PowerShell` に入るための運用手順を追える
3. `scripts/Invoke-RemoteRecover.ps1 -WhatIf` を実行すると、summary は `kisaragi-db/--devs/--testlogs/prj-remote-pwsh/` に、raw evidence は `kisaragi-db/--exsams/prj-remote-pwsh/` に残る
...
- `kisaragi-db/--devs/--project-truth/prj-remote-pwsh/recovery_contract.md`
- `kisaragi-db/--devs/--evidence/prj-remote-pwsh/ux_check_manual.md`
- `kisaragi-db/--exsams/prj-remote-pwsh/artifacts/20260320-153627-rr-20260320-153627-summary.json`
...
- `/codex status` の capture を `kisaragi-db/--exsams/prj-remote-pwsh/captures/` に定型保存する
- GUI fallback の reachability と共通 script 起動を確認する
- 主系統優先と手動介入の decision matrix を runbook 化する

## Evidence

- `kisaragi-db/--exsams/prj-remote-pwsh/logs/20260320-183435-rr-20260320-183435-resume.json`
- `kisaragi-db/--exsams/prj-remote-pwsh/logs/20260320-183559-rr-20260320-183559-doctor.json`
- `kisaragi-db/--exsams/prj-remote-pwsh/artifacts/20260320-183559-rr-20260320-183559-summary.json`
...
- `kisaragi-db/--exsams/prj-remote-pwsh/logs/20260321-052306-rr-20260321-052306-resume.json`
- `kisaragi-db/--exsams/prj-remote-pwsh/artifacts/20260321-052408-rr-20260321-052408-summary.json`
...
1. `kisaragi-db/--devs/--evidence/prj-remote-pwsh/ux_check_manual.md` を見れば、SSH 継続と GUI fallback の切替判断を含む運用手順が追える
...
- `kisaragi-db/--exsams/prj-remote-pwsh/artifacts/20260321-054028-rr-20260321-054028-summary.json`
- `kisaragi-db/--exsams/prj-remote-pwsh/captures/20260321-084541-rr-20260321-084541-slack-status.png`
