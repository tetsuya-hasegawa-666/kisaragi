...
| --- | --- | --- |
| `AGENTS.md` | `Shared Governance Core` | `shared-governance-core.md` |
| `AGENTSmd-RH.md` | `Shared Governance Core History` | `shared-governance-core-history.md` |
| `kisaragi-skills/agents.md` | `Skill Structure Ledger` | `skill-structure-ledger.md` |
